...
/**
 * REST controller for managing {@link com.nttdata.myztl.domain.Varco}.
 */
@RestController
@RequestMapping("/api")
public class VarcoResource {
    ...
    public ResponseEntity<Varco> updateVarco(@Valid @RequestBody Varco varco) throws URISyntaxException {
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, varco.getId().toString()))
            .body(result);
    }
