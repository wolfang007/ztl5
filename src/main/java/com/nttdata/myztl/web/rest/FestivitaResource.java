...
/**
 * REST controller for managing {@link com.nttdata.myztl.domain.Festivita}.
 */
@RestController
@RequestMapping("/api")
public class FestivitaResource {
    ...
    public ResponseEntity<Festivita> updateFestivita(@Valid @RequestBody Festivita festivita) throws URISyntaxException {
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, festivita.getId().toString()))
            .body(result);
    }
