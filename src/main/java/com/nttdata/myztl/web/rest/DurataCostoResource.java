...
/**
 * REST controller for managing {@link com.nttdata.myztl.domain.DurataCosto}.
 */
@RestController
@RequestMapping("/api")
public class DurataCostoResource {
    ...
    public ResponseEntity<DurataCosto> updateDurataCosto(@Valid @RequestBody DurataCosto durataCosto) throws URISyntaxException {
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, durataCosto.getId().toString()))
            .body(result);
    }
