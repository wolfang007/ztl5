...
/**
 * REST controller for managing {@link com.nttdata.myztl.domain.Motivazione}.
 */
@RestController
@RequestMapping("/api")
public class MotivazioneResource {
    ...
    public ResponseEntity<Motivazione> updateMotivazione(@Valid @RequestBody Motivazione motivazione) throws URISyntaxException {
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, motivazione.getId().toString()))
            .body(result);
    }
