...
/**
 * REST controller for managing {@link com.nttdata.myztl.domain.TipologiaPermesso}.
 */
@RestController
@RequestMapping("/api")
public class TipologiaPermessoResource {
    ...
    public ResponseEntity<TipologiaPermesso> updateTipologiaPermesso(@Valid @RequestBody TipologiaPermesso tipologiaPermesso)
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, tipologiaPermesso.getId().toString()))
            .body(result);
    }
