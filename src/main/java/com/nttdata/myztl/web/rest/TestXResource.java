...
/**
 * REST controller for managing {@link com.nttdata.myztl.domain.TestX}.
 */
@RestController
@RequestMapping("/api")
public class TestXResource {
    ...
    public ResponseEntity<TestX> updateTestX(@RequestBody TestX testX) throws URISyntaxException {
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, testX.getId().toString()))
            .body(result);
    }
