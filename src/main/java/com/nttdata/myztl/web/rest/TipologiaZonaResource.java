...
/**
 * REST controller for managing {@link com.nttdata.myztl.domain.TipologiaZona}.
 */
@RestController
@RequestMapping("/api")
public class TipologiaZonaResource {
    ...
    public ResponseEntity<TipologiaZona> updateTipologiaZona(@Valid @RequestBody TipologiaZona tipologiaZona) throws URISyntaxException {
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, tipologiaZona.getId().toString()))
            .body(result);
    }
