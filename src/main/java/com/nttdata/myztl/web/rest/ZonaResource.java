...
/**
 * REST controller for managing {@link com.nttdata.myztl.domain.Zona}.
 */
@RestController
@RequestMapping("/api")
public class ZonaResource {
    ...
    public ResponseEntity<Zona> updateZona(@Valid @RequestBody Zona zona) throws URISyntaxException {
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, zona.getId().toString()))
            .body(result);
    }
