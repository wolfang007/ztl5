...
/**
 * REST controller for managing {@link com.nttdata.myztl.domain.GruppoVarchi}.
 */
@RestController
@RequestMapping("/api")
public class GruppoVarchiResource {
    ...
    public ResponseEntity<GruppoVarchi> updateGruppoVarchi(@Valid @RequestBody GruppoVarchi gruppoVarchi) throws URISyntaxException {
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, gruppoVarchi.getId().toString()))
            .body(result);
    }
