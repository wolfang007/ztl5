...
/**
 * REST controller for managing {@link com.nttdata.myztl.domain.TipologiaVeicolo}.
 */
@RestController
@RequestMapping("/api")
public class TipologiaVeicoloResource {
    ...
    public ResponseEntity<TipologiaVeicolo> updateTipologiaVeicolo(@Valid @RequestBody TipologiaVeicolo tipologiaVeicolo)
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, tipologiaVeicolo.getId().toString()))
            .body(result);
    }
