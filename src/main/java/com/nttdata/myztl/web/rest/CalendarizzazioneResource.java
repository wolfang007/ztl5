...
/**
 * REST controller for managing {@link com.nttdata.myztl.domain.Calendarizzazione}.
 */
@RestController
@RequestMapping("/api")
public class CalendarizzazioneResource {
    ...
    public ResponseEntity<Calendarizzazione> updateCalendarizzazione(@RequestBody Calendarizzazione calendarizzazione)
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, calendarizzazione.getId().toString()))
            .body(result);
    }
