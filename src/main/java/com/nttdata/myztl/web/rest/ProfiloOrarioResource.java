...
/**
 * REST controller for managing {@link com.nttdata.myztl.domain.ProfiloOrario}.
 */
@RestController
@RequestMapping("/api")
public class ProfiloOrarioResource {
    ...
    public ResponseEntity<ProfiloOrario> updateProfiloOrario(@Valid @RequestBody ProfiloOrario profiloOrario) throws URISyntaxException {
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, profiloOrario.getId().toString()))
            .body(result);
    }
