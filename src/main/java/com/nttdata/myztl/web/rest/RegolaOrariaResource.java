...
/**
 * REST controller for managing {@link com.nttdata.myztl.domain.RegolaOraria}.
 */
@RestController
@RequestMapping("/api")
public class RegolaOrariaResource {
    ...
    public ResponseEntity<RegolaOraria> updateRegolaOraria(@Valid @RequestBody RegolaOraria regolaOraria) throws URISyntaxException {
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, regolaOraria.getId().toString()))
            .body(result);
    }
